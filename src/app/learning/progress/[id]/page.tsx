...
export default function LearningDataDetailPage() {
    const router = useRouter();

    return (
        <Layout headerTitle="AI 모델 학습 플랫폼">
            <div className="w-full flex flex-col">
                <SemiHeader headerTitle="인공지능 학습 요약" />

                <div className="flex flex-col p-6 gap-6">
                    <h2 className="text-2xl text-black font-bold">학습 현황</h2>
